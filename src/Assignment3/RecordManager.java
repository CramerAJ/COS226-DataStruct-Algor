...
public class RecordManager {
	...
	public static void c (int k){				//creates a ktree
	...
	public static void e (int k){			//functions e
	...
	public static void s (int k, float d/*node*/){							//checks first if the tree is empty
	...
	public static void d (int k){								//calls the remove method from Ktree_searchtree
																//and does a for loop
	...
	public static void r (int k){								//Not sure on this function
	...
	public static void xs(){									//for xs and xh, I interpreted them as the same
	...
	public static void xa(){								//just simply outputs the preorder ktree
	...
	public static void main(String[] args){												//static main
		...
		Scanner scan = new Scanner(System.in);											//Program, and perform commands
											//To create a small ktree(linked/list)\
		System.out.println("Example Command:");
		System.out.println("(Command)_int_float(_ is a space betweeen the two of them");
